...
export async function generateGapQuestion(): Promise<GapQuestionResult> {
  ...
  return generateGapQuestionForUser(client as unknown as DbClient, user.id)
}
...
export async function generateGapAnalysis(): Promise<GapAnalysisResult> {
  ...
  return generateGapAnalysisForUser(client as unknown as DbClient, user.id)
}
